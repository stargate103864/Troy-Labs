...
public class Java8ReplaceAllPractice {
    ...
    public static List<Integer> squareOnePlaceValue(List<Integer> nums) {
        nums.replaceAll(num -> {
                    int onesPlaceValue = num % 10;
                    return onesPlaceValue * onesPlaceValue;
            });
    ...
    public static List<String> stickWordsInMiddleOfPhrase(List<String> words, String phrase) {
        words.replaceAll(word -> phrase.substring(0, Math.min(3, phrase.length())) + word +
                phrase.substring(3));
    ...
    public static List<String> removePhrase(List<String> words, String phrase) {
        /*
         *     *******   Warning:   the String method 
         *     *******              replaceAll uses regualr expressions  
         *     *******   
         *     *******   The list of people who would use the String 
         *     *******     method replaceALL and failed to solve this 
         *     *******     problem is LONG and illustrious.
         *     *******
         *     *******   The Stream method replaceALL is OK to use.
         *     *******     (theat isL words.replaceAll)
         *     *******   
         */        
        words.replaceAll(word -> word.replaceAll(phrase, ""));
